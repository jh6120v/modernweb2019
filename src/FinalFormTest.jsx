                ...
                return (
                    <Row>
                        <Col style={{ paddingRight: '1rem' }}>
                            ...
                            <p>Click <strong>Reset</strong> and input something for the first 10 text fields (marked
                                as required). Your goal is to minimze the form render count without exceeding 2
                                renders for a successful form submission. So each time you make change to a text
                                field, it will not rerender the whole form on every change.</p>
                            <FormGroup>
